...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RequestTidakSesuai.class)
    public ResponseEntity<ErrorResponseDto> handleReqTidakSesuai(RequestTidakSesuai exception, WebRequest webRequest) {
